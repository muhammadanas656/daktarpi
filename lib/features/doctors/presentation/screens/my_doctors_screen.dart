...
class _MyDoctorsScreenState extends State<MyDoctorsScreen> with SingleTickerProviderStateMixin {
  ...
  Widget _buildDoctorList(Future<List<Map<String, dynamic>>> future, {required bool isFavoritesTab}) {
      ...
      builder: (context, snapshot) {
        ...
        return ListView.separated(
          ...
          itemBuilder: (context, index) {
            ...
            final isFavorite = isFavoritesTab 
                ? true 
